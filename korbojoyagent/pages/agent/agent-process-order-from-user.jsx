...
export async function getServerSideProps({ req }) {
  ...
  const { data } = await axios.get(process.env.API_URL + "/agentPanel/av1/userOrderProccessToSubAgent/" + decodedToken.userId);
...
export default AgentProcessOrder;
